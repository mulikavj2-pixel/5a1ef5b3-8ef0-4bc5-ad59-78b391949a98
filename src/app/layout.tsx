...
export const metadata: Metadata = {
  title: "Wanderlust Travel Agency | Explore Destinations Worldwide",
  description: "Discover extraordinary travel experiences with our expert guides. We offer curated tours to 150+ destinations worldwide since 2010.",
  keywords: "travel agency, tours, vacations, destinations, travel planning, adventure travel",
  metadataBase: new URL("https://wanderlust.travel"),
  alternates: {
    canonical: "https://wanderlust.travel"
  },
  openGraph: {
    title: "Wanderlust Travel Agency | Explore Destinations Worldwide",
    description: "Discover extraordinary travel experiences with our expert guides. We offer curated tours to 150+ destinations worldwide since 2010.",
  ...
  twitter: {
    ...
    title: "Wanderlust Travel Agency | Explore Destinations Worldwide",
    description: "Discover extraordinary travel experiences with our expert guides."
  },
  robots: {
    index: true,
    follow: true
